...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', marginBottom: 10, borderBottomWidth: 1, borderBottomColor: '#ffffff', paddingBottom: 10 },
...
export function FullTimeOfferLetterPDF({ candidateName, position, salary, startDate, companyRepName, letterDate, department }: Props) {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View>
          ...
          <Text style={styles.titleText}>Employment Offer Letter - {position}</Text>
          <Text style={styles.bodyText}>
            We are pleased to offer you the position of <Text style={styles.bold}>{position}</Text> at <Text style={styles.bold}>Knight Owl</Text>. Your employment will commence on <Text style={styles.bold}>{startDate}</Text>. We are excited to have you join our team as a full-time member.
          </Text>
          <Text style={styles.bodyText}>
            As a <Text style={styles.bold}>{position}</Text> in the <Text style={styles.bold}>{department}</Text> department, you will work closely with our team to deliver high-quality digital solutions, contribute to strategic projects, and help drive the company's growth and innovation.
          </Text>
          ...
          <View style={styles.bulletRow}>
            <Text style={styles.bulletDot}>●</Text>
            <Text style={styles.bulletLabel}>Start Date: </Text>
            <Text style={styles.bulletValue}>{startDate}</Text>
          </View>
          <View style={styles.bulletRow}>
            <Text style={styles.bulletDot}>●</Text>
            <Text style={styles.bulletLabel}>Monthly Salary: </Text>
            <Text style={styles.bulletValue}>LKR {salary}</Text>
          </View>
          <View style={styles.bulletRow}>
            <Text style={styles.bulletDot}>●</Text>
            <Text style={styles.bulletLabel}>Employment Type: </Text>
            <Text style={styles.bulletValue}>Full-Time, Permanent</Text>
          </View>
          <View style={styles.bulletRow}>
            <Text style={styles.bulletDot}>●</Text>
          ...
          <Text style={styles.bodyText}>
            This offer is contingent upon your acceptance and adherence to Knight Owl's policies and code of conduct, which will be shared upon your onboarding. To confirm your acceptance, please reply to this email or provide a signed copy of this letter.
          </Text>
          <Text style={styles.bodyText}>We look forward to welcoming you to the Knight Owl family!</Text>
